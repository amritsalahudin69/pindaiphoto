          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="alert alert-success alert-dismissible fade show" role="alert">
                Judul Meta : <?php echo $meta->judul ?>
              </div>

              <div class="alert alert-warning alert-dismissible fade show" role="alert">
                Tagline : <?php echo $meta->site_ ?>
              </div>
              ...
              <div class="card-body">
                <form class="add" method="POST">
                  ...
                  <div>
                      <?php echo form_label('Judul Meta', 'judul', array('class' => 'control-label col-sm-12')); ?>
                      <div class="col-sm-12">
                          <?php echo form_input($ijudul) . form_error('judul'); ?>
                      </div>
                  </div>
