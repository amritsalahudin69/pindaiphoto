...
<div class="col ml-3 mb-1">
  <a href="<?php echo site_url('secclientadd') ?>" class="btn btn-primary btn-icon-split">
                        ...
                        <tbody>
                            ...
                            if (isset($data)) {
                                foreach ($data as $d) {
                                    ...
                                    echo "<td>{$i}</td>";
                                    echo "<td>{$d['nama']}</td>";
                                    echo "<td>{$d['backlink']}</td>";
                                    echo "<td>{$d['phone']}</td>";
                                    echo "<td class='col-sm-2 col-md-2'>
                                         <div class='col-6'>
                                            <img src ='assets/upload_gambar/" . $d['logo'] . "' alt='Image' class='img-fluid'>
                                         </div>
                                        </td>";
                                    ...
                                    echo "<td>
                                                <a class='ubah' name='ubah' id='ubah'href='" . site_url('hapusr/' . $d['id']) . "'>
